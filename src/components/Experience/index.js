...
const Experience = () => (
  <section className="container mx-auto px-4 py-8">
    <h2 className="text-white font-serif text-4xl font-bold mb-8 text-center">Professional Experience</h2>
    <div className="flex flex-wrap -mx-4">
    <div className="w-full md:w-1/2 lg:w-1/3 px-4 mb-8">
        <div className="bg-white rounded-lg shadow-lg p-6 hover:shadow-xl transition duration-300">
          <h3 className="text-2xl font-bold mb-4">Programmer Analyst Trainee</h3>
          <hr/>
          <p className="text-gray-700">Cognizant, Chennai, India</p>
          <p className="text-gray-700">Nov 2015 - Nov 2016</p>
          <hr/>
          <ul className="mt-4 list-decimal decorated-list">
      ...
      <div className="w-full md:w-1/2 lg:w-1/3 px-4 mb-8">
        <div className="bg-white rounded-lg shadow-lg p-6 hover:shadow-xl transition duration-300">
          ...
          <hr/>
          <p className="text-gray-700">Nxtwave Disruptive Technologies Private Limited</p>
          <p className="text-gray-700">Dec 2022 - Oct 2023</p>
          <hr/>
          <ul className="mt-4 list-decimal decorated-list">
      ...
      <div className="w-full md:w-1/2 lg:w-1/3 px-4 mb-8">
        <div className="bg-white rounded-lg shadow-lg p-6 hover:shadow-xl transition duration-300">
          ...
          <hr/>
          <p className="text-gray-700">HR India Private Limited, Chennai, India</p>
          <p className="text-gray-700">Oct 2023 - Apr 2024</p>
          <hr/>
          <ul className="mt-4 list-decimal decorated-list h-auto overflow-y">
